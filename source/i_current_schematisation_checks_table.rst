.. list-table:: Executed checks
   ...
   * - 0007
     - Error
     - v2_aggregation_settings.flow_variable is not one of {'rain', 'discharge', 'wet_cross-section', 'flow_velocity', 'wet_surface', 'volume', 'surface_source_sink_discharge', 'pump_discharge', 'leakage', 'simple_infiltration', 'interception', 'waterlevel', 'lateral_discharge'}
   * - 0007
     - Error
     - v2_aggregation_settings.aggregation_method is not one of {'sum', 'cum_negative', 'avg', 'cum_positive', 'max', 'min', 'current', 'cum'}
   * - 0008
     - Error
   ...
   * - 0007
     - Error
     - v2_control_memory.action_type is not one of {'set_gate_level', 'set_discharge_coefficients', 'set_pump_capacity', 'set_capacity', 'set_crest_level'}
   * - 0007
     - Error
     - v2_control_memory.target_type is not one of {'v2_channel', 'v2_orifice', 'v2_weir', 'v2_pipe', 'v2_pumpstation', 'v2_culvert'}
   * - 0008
     - Error
     - id must be a positive signed 32-bit integer.
   * - 0002
   ...
   * - 0007
     - Error
     - v2_control_table.action_type is not one of {'set_gate_level', 'set_discharge_coefficients', 'set_pump_capacity', 'set_capacity', 'set_crest_level'}
   * - 0007
     - Error
   ...
   * - 0007
     - Error
     - v2_control_table.target_type is not one of {'v2_channel', 'v2_orifice', 'v2_weir', 'v2_pipe', 'v2_pumpstation', 'v2_culvert'}
   * - 0008
     - Error
     - id must be a positive signed 32-bit integer.
   * - 0002
   ...
   * - 0007
     - Error
     - v2_control_timed.action_type is not one of {'set_gate_level', 'set_discharge_coefficients', 'set_pump_capacity', 'set_capacity', 'set_crest_level'}
   * - 0007
     - Error
     - v2_control_timed.target_type is not one of {'v2_channel', 'v2_orifice', 'v2_weir', 'v2_pipe', 'v2_pumpstation', 'v2_culvert'}
   * - 0008
     - Error
     - id must be a positive signed 32-bit integer.
   * - 0002
   ...
   * - 0007
     - Error
     - v2_impervious_surface.surface_class is not one of {'half verhard', 'gesloten verharding', 'pand', 'onverhard', 'open verharding'}
   * - 0007
     - Info
