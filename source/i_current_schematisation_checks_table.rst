.. list-table:: Executed checks
   ...
   * - 0007
     - Error
     - v2_aggregation_settings.flow_variable is not one of {'lateral_discharge', 'leakage', 'discharge', 'surface_source_sink_discharge', 'rain', 'interception', 'pump_discharge', 'waterlevel', 'volume', 'flow_velocity', 'simple_infiltration', 'wet_cross-section', 'wet_surface'}
   * - 0007
     - Error
     - v2_aggregation_settings.aggregation_method is not one of {'max', 'sum', 'current', 'cum_negative', 'avg', 'cum', 'min', 'cum_positive'}
   * - 0008
     - Error
   ...
   * - 0007
     - Error
     - v2_control_memory.measure_variable is not one of {'volume', 'waterlevel', 'velocity', 'discharge'}
   * - 0007
     - Error
     - v2_control_memory.action_type is not one of {'set_gate_level', 'set_crest_level', 'set_capacity', 'set_discharge_coefficients', 'set_pump_capacity'}
   * - 0007
     - Error
     - v2_control_memory.target_type is not one of {'v2_culvert', 'v2_pumpstation', 'v2_channel', 'v2_weir', 'v2_pipe', 'v2_orifice'}
   * - 0008
     - Error
     - id must be a positive signed 32-bit integer.
   * - 0002
   ...
   * - 0007
     - Error
     - v2_control_table.action_type is not one of {'set_gate_level', 'set_crest_level', 'set_capacity', 'set_discharge_coefficients', 'set_pump_capacity'}
   * - 0007
     - Error
     - v2_control_table.measure_variable is not one of {'volume', 'waterlevel', 'velocity', 'discharge'}
   * - 0007
     - Error
     - v2_control_table.measure_operator is not one of {'<', '>=', '<=', '>'}
   * - 0007
     - Error
     - v2_control_table.target_type is not one of {'v2_culvert', 'v2_pumpstation', 'v2_channel', 'v2_weir', 'v2_pipe', 'v2_orifice'}
   * - 0008
     - Error
     - id must be a positive signed 32-bit integer.
   * - 0002
   ...
   * - 0007
     - Error
     - v2_control_timed.action_type is not one of {'set_gate_level', 'set_crest_level', 'set_capacity', 'set_discharge_coefficients', 'set_pump_capacity'}
   * - 0007
     - Error
     - v2_control_timed.target_type is not one of {'v2_culvert', 'v2_pumpstation', 'v2_channel', 'v2_weir', 'v2_pipe', 'v2_orifice'}
   * - 0008
     - Error
     - id must be a positive signed 32-bit integer.
   * - 0002
   ...
   * - 0007
     - Error
     - v2_impervious_surface.surface_inclination is not one of {'vlak', 'hellend', 'uitgestrekt'}
   * - 0007
     - Error
     - v2_impervious_surface.surface_class is not one of {'pand', 'gesloten verharding', 'open verharding', 'onverhard', 'half verhard'}
   * - 0007
     - Info
